...
export default function RangeSlider() {
  ...
  const bathroomsRange = useSelector(state => state.bathroomsRange);
  ...
  const updateStore = () =>{
    const payload = {fieldName:'selectedBathroomRange', fieldValue:{value: minmax,validationStatus: false}}  
  ...
  return (
    ...
    <>
      ...
      <Typography id="range-slider" gutterBottom>
        Bathrooms [min: {minmax[0]} &nbsp;  max: {minmax[1]}]      
      </Typography>
      ...
      <RaisedFormControl justify="center" alignItems="center">
          <Slider
              ...
              marks={marks} 
              min={bathroomsRange[0]}
              max={bathroomsRange[1]}
              value={minmax}
